...
/*This is a simple wrapper class to make this table immutable*/
public class RegisterTable {
    private static final HashMap<String, Integer> registerTable;
    static{
        registerTable = new HashMap<>();
        registerTable.put("$zero", 0);
        registerTable.put("$0", 0);
        registerTable.put("$r0", 0);
        ...
        registerTable.put("$s8", 30);
        registerTable.put("$ra", 31);
    }

    public RegisterTable(){ }

    public static HashMap<String, Integer> getRegisterTable(){
        return registerTable;
    }
    public static int getRegisterOpCode(String key) { return registerTable.get(key); }
}
